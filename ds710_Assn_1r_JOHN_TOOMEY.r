...
# The sd function computes standard deviation for a vector (numeric) - more specificall it returns the standard deviation by taking two aurgguments:
# the first argument is a vector containing numeric values
# the second argument is a logical type indicating whether "na" (missing) variables should be removed before computation begins

#1.9. Create a variable Name that contains your first name.  
name = "John (Jack)"
paste("My name is", name)
[1] "My name is John (Jack)"
